...
fun ShopPenEntity.toShopPen(): ShopPen {
    return when (val pen = this.pen) {
        is ShopPen.Basic -> {
            ShopPen.Basic(pen.color, pen.penPrice, bought, equipped, pen.type)
        }

        is ShopPen.Legendary -> {
            ShopPen.Legendary(pen.colors, pen.penPrice, bought, equipped, pen.type)
        }

        is ShopPen.Premium -> {
            ShopPen.Premium(pen.color, pen.penPrice, bought, equipped, pen.type)
        }
    }
}
...
fun ShopPen.toShopEntity(): ShopPenEntity {
    return when (this) {
        is ShopPen.Basic -> {
            ShopPenEntity(pen = this, equipped = this.penEquipped, bought = this.penBought)
        }
