...
class GameRepositoryImpl @javax.inject.Inject constructor(
    ...
    override suspend fun getResultScore(
        ...
        return withContext(Dispatchers.Default) {
            ...
            val strokeWidthMultiplier = when (difficultyLevelOption) {
                DifficultyLevelOptions.Beginner -> 10f      // Reduced from 15f
                DifficultyLevelOptions.Challenging -> 8f    // Increased from 7f
                DifficultyLevelOptions.Master -> 6f         // Increased from 4f
            }
    ...
    private fun applyConsistentPenalties(
        ...
        val difficultyFactor = when (difficultyLevel) {
            DifficultyLevelOptions.Beginner -> 1.05f      // 5% boost for beginner
            DifficultyLevelOptions.Challenging -> 1.0f    // No adjustment for challenging
            DifficultyLevelOptions.Master -> 0.95f        // 5% reduction for master
        }
