...
| ![Home Screen](screenshots/home_screen.jpg) | ![Game Mode Screen](screenshots/game_mode_screen.jpg) |
|:-------------------------------------------:|:-----------------------------------------------------:|
|                *Home Screen*                |                 *Game Mode Selection*                 |

| ![Game Preview](screenshots/game_preview_screen.jpg) | ![Game Screen](screenshots/game_screen.jpg) |
|:----------------------------------------------------:|:-------------------------------------------:|
|                    *Game Preview*                    |                *Game Canvas*                |

| ![Game Result](screenshots/game_endless_result_screen.jpg) | ![Endless Mode Result](screenshots/game_result_screen.jpg) |
|:----------------------------------------------------------:|:----------------------------------------------------------:|
|               *Result Screen (Endless mode)*               |                  *Result Screen (Normal)*                  |

| ![Shop: Pen](screenshots/shop_pen_screen.jpg) | ![Shop: Drawboard](screenshots/shop_drawboard_screen.jpg) |
|:---------------------------------------------:|:---------------------------------------------------------:|
...
> _All screenshots are in the [`screenshots/`](screenshots) folder. Each file name matches the
screen title._
